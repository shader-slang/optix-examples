...
namespace osc {
  ...
  void SampleRenderer::createMissPrograms()
  {
    ...
    // shadow rays
    // ------------------------------------------------------------------
    pgDesc.miss.entryFunctionName = "__miss__miss_shadow";
  ...
  void SampleRenderer::createHitgroupPrograms()
  {
    ...
    // in shadow
    // -------------------------------------------------------
    pgDesc.hitgroup.entryFunctionNameCH = "__closesthit__closesthit_shadow";
    pgDesc.hitgroup.entryFunctionNameAH = "__anyhit__anyhit_shadow";
